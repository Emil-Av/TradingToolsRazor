...
namespace DataAccess.MigrationsPostgreSQL
{
    ...
    [Migration("20260506120649_AddEspresso")]
    partial class AddEspresso
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Trades.Espresso", b =>
                {
                    b.HasBaseType("Models.Trades.BaseTrade");
                    ...
                    b.ToTable("Espresso", (string)null);
                });
            ...
            modelBuilder.Entity("Models.Trades.Espresso", b =>
                {
                    b.HasOne("Models.Trades.BaseTrade", null)
                        .WithOne()
                        .HasForeignKey("Models.Trades.Espresso", "Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
